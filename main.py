...
user_inp_embedding = data_processing.create_user_input_embedding(user_input_list=user_inp_list)

responses, _,_ = data_processing.compute_similarity(user_inp_embedding, threshold= 0.4)
# print(responses)

results = chatbot.generate_response(responses = responses)
print(results)
